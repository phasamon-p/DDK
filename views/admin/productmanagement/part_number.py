...
class Part_Number:
    ...
    def __init__(self, editstage):
        ...
        if self.editstage:
            self.caption = 'Edit part number'
            self.title = 'EDIT PART NUMBER'
        else:
            self.caption = 'Add part number'
            self.title = 'ADD PART NUMBER'
    ...
    def run(self):
        ...
        self.partnumber_input = elements.InputBox_Userid(1, 3, 10, 1, views.product_data.product_data['part_number'], app = (self.screen), active = True, numpad_active = True)
        ...
        while self.running:
            ...
            for event in pygame.event.get():
                self.partnumber_value = self.partnumber_input.handle_event(event)
