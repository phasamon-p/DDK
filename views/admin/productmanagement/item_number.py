...
class Item_Number:
    ...
    def __init__(self, editstage):
        ...
        if self.editstage:
            self.caption = 'Edit item number'
            self.title = 'EDIT ITEM NUMBER'
        else:
            self.caption = 'Add item number'
            self.title = 'ADD ITEM NUMBER'
    ...
    def run(self):
        ...
        self.itemnumber_input = elements.InputBox_Userid(1, 3, 10, 1, views.product_data.product_data['item_number'], app = (self.screen), active = True, numpad_active = True)
        print("UProduct_data :", views.product_data.product_data)
        ...
        while self.running:
            ...
            for event in pygame.event.get():
                self.itemnumber_value = self.itemnumber_input.handle_event(event)
