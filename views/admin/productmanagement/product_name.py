...
class Product_Name:
    ...
    def __init__(self, editstage):
        ...
        if self.editstage:
            self.caption = 'Edit product name'
            self.title = 'EDIT PRODUCT NAME'
        else:
            self.caption = 'Add product name'
            self.title = 'ADD PRODUCT NAME'
    ...
    def run(self):
        ...
        self.productname_input = elements.InputBox_Text(1, 3, 10, 1, views.product_data.product_data['product_name'], app = (self.screen), active = True, numpad_active = True)
        ...
        while self.running:
            ...
            for event in pygame.event.get():
                self.productname_value = self.productname_input.handle_event(event)
