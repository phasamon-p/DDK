...
from views.admin.productmanagement import Product_Management, Item_Number, product_data, Product_Name, Part_Number, Part_Name, Drawing_Number, Product_Locker, Quantity, Other, Product_Result, Product_Section, Product_Qrcode, Product_Edit, Inventory_Edit, Product_Drawer
