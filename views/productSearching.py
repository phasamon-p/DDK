...
class Product_Searching:
    ...
    def __init__(self):
        ...
        self.click = {
            (0, 0): 'print("0,0")',
            (9, 8): 'views.Product_Request().run()',
            (9, 9): 'views.Product_Request().run() ',
            (9, 10): 'views.Product_Request().run()'
        }
    ...
    def run(self):
        ...
        elements.Title('PRODUCT SERCHING', pos=(400, 90), app=(self.screen)).draw()
